            ...
            <Animatable.View
                ...
                <Card style={styles.quotation_Box}>
                    ...
                    <View style={styles.quotation_content_box}>
                        ...
                        <Text style={styles.quotatio_Text} numberOfLines={1}>9823004567</Text>
                    </View>
                    {/* <View>
        ...
        <View style={styles.container}>
            <Animatable.View animation={zoomIn}>
                <Header
                    ...
                    screenName="allpropo"
                />
                <Text style={[styles.header_text, { textTransform: "uppercase" }]}>Your all Proposals is here</Text>
                <View style={styles.header_flex_btn}>
                    ...
                    >
                        <View style={styles.header_btn_icon}>
                            <MaterialCommunityIcons style={{ paddingBottom: 5 }} name="sort" size={20} color={'#fff'} />
                        </View>
